...
module.exports = {
   ...
   * @return {Promise}         Promise; if fulfilled returns object, which contains deleted payment; if rejected returns APIerror.
   */
  retrieveSubmission: function (client, params) {
    params = params || {};
    if (!params.hasOwnProperty("id")) {
      throw new Error("id is required");
    }
   ...
   */
  authorise: function (client, params) {
    params = params || {};
   ...
   * @return {Promise}         Promise; if fulfilled returns object, which contains requested payment; if rejected returns APIerror.
   */
  getConfirmation: function (client, params) {
    params = params || {};
    if (!params.hasOwnProperty("id")) {
      throw new Error("id is required");
    }
   ...
   * @return {Promise}                    Promise; if fulfilled returns object, which contains requested payment; if rejected returns APIerror.
   */
  getPaymentDeliveryDate: function (client, params) {
    params = params || {};
   ...
   * @return {Promise}                    Promise; if fulfilled returns object, which contains requested payment; if rejected returns APIerror.
   */
  getQuotePaymentFee: function (client, params) {
    params = params || {};
    if (!params.hasOwnProperty("paymentType")) {
      throw new Error("paymentType is required");
    }
   ...
   */
  getPaymentTrackingInfo: function (client, params) {
    params = params || {};
    if (!params.hasOwnProperty("id")) {
      throw new Error("id is required");
    }
