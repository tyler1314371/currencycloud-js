...
module.exports = {
   ...
   */
  getBeneficiaryRequiredDetails: function (client, params) {
   ...
   */
  getConversionDates: function (client, params) {
    params = params || {};
   ...
   */
  getPaymentDates: function (client, params) {
    params = params || {};
   ...
   */
  getSettlementAccounts: function (client, params) {
   ...
   * @return {Promise}                     Promise; if fulfilled returns object, which contains invalid conversion dates as well as first and default date; if rejected returns APIerror.
   */
  getPayerRequiredDetails: function (client, params) {
    params = params || {};
   ...
   */
  getPaymentPurposeCodes: function (client, params) {
    params = params || {};
    if (!params.hasOwnProperty("currency")) {
      throw new Error("currency is required");
    }
   ...
   */
  getBankDetails: function (client, params) {
    params = params || {};
   ...
   */
  getPaymentFeeRules: function (client, params) {
    params = params || {};
