...
module.exports = {
   ...
   * @deprecated                                Use dateChange instead, this Snake Case method will be removed.
   * @param params
   * @params {String} params.id                 Id of the conversion (required)
   ...
   * */
  date_change: function (client, params) {
    return this.dateChange(client, params);
  },
   ...
   * @return {Promise}                          Promise; if fulfilled returns a json structure containing the details of the conversion date change; if rejected returns APIerror.
   * */
  dateChange: function (client, params) {
    params = params || {};
    if (!params.hasOwnProperty("id")) {
      throw new Error("id is required");
    }
  ...
  /**
   * Execute conversion retrieve profit and loss and returns a json structure containing data about all the profit and/or loss about conversions
   * @deprecated                  Use profitAndLoss instead, this Snake Case method will be removed.
   * @param params
   * @return {Promise}            Promise; if fulfilled returns object, which contains the parent and child conversions; if rejected returns APIerror.
   */
  profit_and_loss: function (client, params) {
    return this.profitAndLoss(client, params);
  },
   ...
   * @return {Promise}            Promise; if fulfilled returns object, which contains the parent and child conversions; if rejected returns APIerror.
   */
  profitAndLoss: function (client, params) {
    params = params || {};
   ...
   * @deprecated                                        Use dateChangeQuote instead, this Snake Case method will be removed.
   * @param params
   * @params {String} params.id                         Id of the conversion (required)
   * @params {Date} params.new_settlement_date          New settlement date (required)
   * @return {Promise}                                  Promise; if fulfilled returns object, which contains the parent and child conversions; if rejected returns APIerror.
   */
  date_change_quote: function (client, params) {
    return this.dateChangeQuote(client, params);
  },
   ...
   * @return {Promise}                                  Promise; if fulfilled returns object, which contains the parent and child conversions; if rejected returns APIerror.
   */
  dateChangeQuote: function (client, params) {
    params = params || {};
    if (!params.hasOwnProperty("id")) {
      throw new Error("id is required");
    }
   ...
   * @deprecated                                        Use splitPreview instead, this Snake Case method will be removed.
   * @param params
   * @params {String} params.id                         Id of the conversion (required)
   * @params {Number} params.amount                     Amount to split by (required)
   * @return {Promise}                                  Promise; if fulfilled returns object, which contains the parent and child conversions; if rejected returns APIerror.
   */
  split_preview: function (client, params) {
    return this.splitPreview(client, params);
  },
   ...
   * @return {Promise}                                  Promise; if fulfilled returns object, which contains the parent and child conversions; if rejected returns APIerror.
   */
  splitPreview: function (client, params) {
    params = params || {};
   ...
   * @deprecated                                        Use splitHistory instead, this Snake Case method will be removed.
   * @param params
   * @params {String} params.id                         Id of the conversion (required)
   * @return {Promise}                                  Promise; if fulfilled returns object, which contains the parent and child conversions; if rejected returns APIerror.
   */
  split_history: function (client, params) {
    return this.splitHistory(client, params);
  },
   ...
   * @return {Promise}                                  Promise; if fulfilled returns object, which contains the parent and child conversions; if rejected returns APIerror.
   */
  splitHistory: function (client, params) {
    params = params || {};
  ...
  /**
   * Execute conversion cancellation quote and returns a json structure containing conversion
   * @deprecated                                        Use cancellationQuote instead, this Snake Case method will be removed.
   * @param params
   * @params {String} params.id                         Id of the conversion (required)
   * @return {Promise}                                  Promise; if fulfilled returns object, which contains the parent and child conversions; if rejected returns APIerror.
   */
  cancellation_quote: function (client, params) {
    return this.cancellationQuote(client, params);
  },
   ...
   * @return {Promise}                                  Promise; if fulfilled returns object, which contains the parent and child conversions; if rejected returns APIerror.
   */
  cancellationQuote: function (client, params) {
    params = params || {};
