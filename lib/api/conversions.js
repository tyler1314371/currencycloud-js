...
module.exports = {
  ...
  profit_and_loss: function (params) {
    return this.profitAndLoss(params);
  },
  ...
  date_change_quote: function (params) {
    return this.dateChangeQuote(params);
  },
   ...
   * @return {Promise}                                  Promise; if fulfilled returns object, which contains the parent and child conversions; if rejected returns APIerror.
   */
  dateChangeQuote: function (params) {
    const client = this;
    params = params || {};
    if (!params.hasOwnProperty("id")) {
      throw new Error("id is required");
  ...
  split_preview: function (params) {
    return this.splitPreview(params);
  },
  ...
  split_history: function (params) {
    return this.splitHistory(params);
  },
  ...
  cancellation_quote: function (params) {
    return this.cancellationQuote(params);
  },
   ...
   * @return {Promise}                                  Promise; if fulfilled returns object, which contains the parent and child conversions; if rejected returns APIerror.
   */
  cancellationQuote: function (params) {
    const client = this;
    params = params || {};
